...
class TaTQAEmAndF1(object):
    ...
    def __call__(self,
        ...
        if prediction != 0 and   prediction != -0 and  not prediction:                                    
        #if  not prediction:                                                
            exact_match = 0
            f1_score = 0
            span_exact_match = 0
        ...
        self._count += 1
        #if f1_score < 0.8:# or gold_scale != "":
        #    print(ground_truth)
        #    print("calc ", prediction_strings, pred_scale, ground_truth_answer_strings)
        #    print("f1", f1_score, gold_scale)
        it = {**ground_truth,
              **{"pred":prediction,
